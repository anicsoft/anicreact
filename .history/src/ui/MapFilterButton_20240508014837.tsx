...
export default function MapFilterButton() {
  ...
  return (
    <ActionIcon radius={"xl"} p={ "xl"}  variant="filled" size="xl" aria-label="Settings" pos="fixed" bottom={filterDrawerOpened ? 'calc(20px + 50vh)' : '1.5rem'} right="1.5rem" style={{zIndex:"201", transition: 'bottom 0.2s ease'}} onClick={filterDrawerHandlers.toggle}>
