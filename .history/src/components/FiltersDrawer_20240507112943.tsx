...
export default function FiltersDrawer() {
  ...
  return (
    ...
    <MapFilterButton></MapFilterButton>
      <Drawer position="bottom" radius="md" size="50vh"  withCloseButton={false} opened={filterDrawerOpened} onClose={filterDrawerHandlers.close} transitionProps={{duration: 200, transition: 'pop' }}  title="Authentication">
      {/* Drawer content */}
      LALALALALALALAALL
      </Drawer>
    </Box>
