...
export default function FiltersDrawer() {
  ...
  return (
    ...
    <MapFilterButton></MapFilterButton>
      <Drawer position="bottom" radius="md" size="50vh"  withCloseButton={false} opened={filterDrawerOpened} onClose={filterDrawerHandlers.close} style={{transition: 'height 0.3s ease-in-out'}} title="Authentication">
      {/* Drawer content */}
      LALALALALALALAALL
      </Drawer>
    </Box>
