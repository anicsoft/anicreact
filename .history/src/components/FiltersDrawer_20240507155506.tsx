...
export default function FiltersDrawer() {
  ...
  const offers = ['offer1', 'offer2', 'offer3', 'offeroffer', 'offerofferoffer', 'offer1', 'offer2', 'offer3', 'offeroffer', 'offerofferoffer', 'offer1', 'offer2', 'offer3', 'offeroffer', 'offerofferoffer', 'offer1', 'offer2', 'offer3', 'offeroffer', 'offerofferoffer']
